            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href={`mailto:${profile.email}`} className="text-gray-300 hover:text-green-400 transition-colors">
                    {profile.email}
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-green-400" />
                  <a href={`tel:${profile.phone}`} className="text-gray-300 hover:text-green-400 transition-colors">
                    {profile.phone}
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <ProjectCard key={project.id} project={project} index={index} onClick={() => openProjectModal(project)} />
            ))}
          </div>
        </div>
      </section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${profile.email}`} className="text-white hover:text-green-400 transition-colors">
                        {profile.email}
                      </a>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Full stack web developer passionate about creating innovative solutions and building applications that
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="#projects" className="block text-gray-400 hover:text-green-400 transition-colors text-sm">
                  Projects
                </a>
                <a href="#contact" className="block text-gray-400 hover:text-green-400 transition-colors text-sm">
                  Contact
                </a>
              </div>
            </div>
